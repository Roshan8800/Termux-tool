...
import json
from termux_cyber_framework.agents.config_recovery_agent import ConfigRecoveryAgent
...
class TestConfigRecoveryAgent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.agent = ConfigRecoveryAgent(
    ...
    def test_restore_from_backup_success(self):
        ...
        self.agent._check_config_integrity()
    ...
    def test_check_tool_availability_missing_logs_warning(self):
        ...
        with patch('shutil.which', return_value=None):
            self.agent._check_tool_availability()
            self.mock_logger.log.assert_any_call(
